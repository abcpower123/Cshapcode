...
namespace WindowsFormsApp1 {
    ...
    public partial class SalesDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public CustomersRow AddCustomersRow(string CustomerName, string Email, string Password, string Phone, string Address, int VIP) {
        ...
        public partial class CustomersRow : global::System.Data.DataRow {
            ...
            public int VIP {
                get {
                    return ((int)(this[this.tableCustomers.VIPColumn]));
                }
                set {
...
namespace WindowsFormsApp1.SalesDataSetTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Customers] WHERE (([Id] = @Original_Id) AND ([CustomerName] = @Original_CustomerName) AND ([Email] = @Original_Email) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) AND ([Phone] = @Original_Phone) AND ([Address] = @Original_Address) AND ([VIP] = @Original_VIP))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Customers] ([CustomerName], [Email], [Password], [Phone], [Address], [VIP]) VALUES (@CustomerName, @Email, @Password, @Phone, @Address, @VIP);
SELECT Id, CustomerName, Email, Password, Phone, Address, VIP FROM Customers WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customers] SET [CustomerName] = @CustomerName, [Email] = @Email, [Password] = @Password, [Phone] = @Phone, [Address] = @Address, [VIP] = @VIP WHERE (([Id] = @Original_Id) AND ([CustomerName] = @Original_CustomerName) AND ([Email] = @Original_Email) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) AND ([Phone] = @Original_Phone) AND ([Address] = @Original_Address) AND ([VIP] = @Original_VIP));
SELECT Id, CustomerName, Email, Password, Phone, Address, VIP FROM Customers WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApp1.Properties.Settings.Default.SalesConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, CustomerName, Email, Password, Phone, Address, VIP FROM dbo.Customers";
        ...
        public virtual int Delete(int Original_Id, string Original_CustomerName, string Original_Email, string Original_Password, string Original_Phone, string Original_Address, int Original_VIP) {
            ...
            this.Adapter.DeleteCommand.Parameters[7].Value = ((int)(Original_VIP));
        ...
        public virtual int Insert(string CustomerName, string Email, string Password, string Phone, string Address, int VIP) {
            ...
            this.Adapter.InsertCommand.Parameters[5].Value = ((int)(VIP));
        ...
        public virtual int Update(string CustomerName, string Email, string Password, string Phone, string Address, int VIP, int Original_Id, string Original_CustomerName, string Original_Email, string Original_Password, string Original_Phone, string Original_Address, int Original_VIP, int Id) {
            if ((CustomerName == null)) {
                throw new global::System.ArgumentNullException("CustomerName");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(VIP));
            ...
            this.Adapter.UpdateCommand.Parameters[13].Value = ((int)(Original_VIP));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string CustomerName, string Email, string Password, string Phone, string Address, int VIP, int Original_Id, string Original_CustomerName, string Original_Email, string Original_Password, string Original_Phone, string Original_Address, int Original_VIP) {
            return this.Update(CustomerName, Email, Password, Phone, Address, VIP, Original_Id, Original_CustomerName, Original_Email, Original_Password, Original_Phone, Original_Address, Original_VIP, Original_Id);
        }
    }
